...
5. **Power BI dashboard** - [see PDF export](dashboard/insurance_risk_analysis_dashboard.pdf) with 4 pages covering portfolio overview, segment analysis, claim severity, and pricing flags
